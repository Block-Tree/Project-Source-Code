...
/**
---------------------------------------------------------------------------------------------------
 Telegram: https://t.me/MoneyTokenERCPortal
 Twitter: https://twitter.com/moneyerc
 
 Contract Developed by Anoop [Developed over 350+ contracts]: https://t.me/AnoopSafuDeveloper
...
contract MONEY is BEP20, Ownable {
    ...
    constructor() BEP20("MONEY", "$MONEY") {
        _tokengeneration(msg.sender, 69e6 * 10**decimals());
